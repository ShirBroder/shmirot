...
- Name: shmirot.spec.ts >> Shmirot App >> can add multiple people
- Location: e2e/shmirot.spec.ts:40:3
...
Locator: locator('.space-y-2').locator('text=David')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.space-y-2').locator('text=David')
    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e14]:
        - generic [ref=e15]:
          ...
          - textbox "Enter name" [ref=e17]: Sarah
        - generic [ref=e18]:
