...
- Name: shmirot.spec.ts >> Shmirot App >> can add a person
- Location: e2e/shmirot.spec.ts:29:3
...
Call log:
  ...
  - waiting for locator('text=David')
    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e14]:
        ...
        - generic [ref=e18]:
          ...
          - textbox "Optional notes..." [ref=e20]: Morning person
        - generic [ref=e21]:
